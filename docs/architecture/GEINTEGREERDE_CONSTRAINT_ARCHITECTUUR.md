...
**Status:** ✅ **ACTIEF DESIGN** - Architectuur Richtlijn (3 nov 2025)
**Target Release:** v0.6.26 (HR Validatie met ConstraintChecker laag) + v0.7.0+ (AI Generator)

⚠️ **Gebruik:** Dit document beschrijft de toekomstbestendige architectuur.
Combineer met `HR_VALIDATIE_SYSTEEM_DESIGN.md` voor concrete implementatie details.
